                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                            ...
                            <a><span>
                                    <div class="fb-login-button" data-max-rows="1" data-size="icon" data-show-faces="false" data-auto-logout-link="true">
...
<script>
  ...
  function statusChangeCallback(response) {
    ...
    if (response.status === "connected") {
      ...
      window.location.assign("http://localhost:8080/IDIC/")
      window.location.assign("http://localhost:8080/IDIC/Encuesta.jsp")
      testAPI();
    } 
  }
